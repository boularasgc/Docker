...
/*   Updated: 2020/02/04 22:42:52 by mboulara         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (flag & pbin_F)
		ft_fprintf(rsa.outfile, "Public-Key:");
	else
		ft_fprintf(rsa.outfile, "Private-Key:");
	ft_fprintf(rsa.outfile, " (%d bit)\n", get_bit_length(&rsa.modulus,
	sizeof(rsa.modulus)));
